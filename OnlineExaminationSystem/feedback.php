...
<div class="col-md-10">
<a href="mailto:developer@admin.com" style="color:#000000">developer@admin.com</a><br /><br />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="# style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Developer</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9999999999</h4>
		<h4 style="font-family:'typo' ">developer@admin.com</h4>
		<h4 style="font-family:'typo' ">Adamas University</h4></div></div>
		</p>
      </div>
