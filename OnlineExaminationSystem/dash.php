...
{
echo '<tr style="color:#99cc32"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="This quiz is already solved by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$total.'</td><td>'.$correct*$total.'</td><td>'.$time.'&nbsp;min</td>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="wrong" name="wrong" placeholder="Enter negative marking on wrong answer without sign" class="form-control input-md" min="0" type="number">
